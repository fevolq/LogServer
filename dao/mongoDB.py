...
class Mongo:
    ...
    def __init__(self, db_name, db_conf, *, use_pool=True) -> None:
    ...
    def execute(self, collection_name: str, action: str, *args, **kwargs) -> dict:
        """
        ...
        :return:
        """
        raise_error = kwargs.pop('raise_error', True)  # 是否扔出异常
...
if __name__ == '__main__':
    # result = execute('user', 'find', '', db_name='test')
    # result = execute('user', 'insert_many', [{'name': 'test_01'}], db_name='test')
    # print(result)
    ...
